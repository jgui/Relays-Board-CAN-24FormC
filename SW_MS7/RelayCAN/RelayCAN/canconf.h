 ...
 * consistent setting. Omitting the #defines in both can-lib and application
 ...
 *
 * Reminder: only 16MHz clock is supported
 */
#define	MCP2515_CS				B,2   // SPI slave select pin
//#define	MCP2515_INT				D,2   // do not define so interrupt in no used

#define MCP2515_CLKOUT_PRESCALER        2  // do not define or set to 0 to disable CLKOUT
...
// Number of CAN messages which are buffered in RAM additionally to the MObs
